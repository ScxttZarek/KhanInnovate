...
function setupMain(){
    ...
    (function () {
        const phrases = [ 
            "Get good, get [**InnovationKhan**](https://github.com/ScxttZarek/KhanInnovate/)!",
            "Made by [**@MyokoKyle**](https://github.com/MyokoKyle).",
            "By [**ScxttZarek/innovationkhan**](https://github.com/ScxttZarek/KhanInnovate/).",
        ...
        const modifyItemData = (itemData) => {
            if (itemData.question.content?.[0] === itemData.question.content[0].toUpperCase()) {
                ...
                itemData.question.content = phrases[Math.floor(Math.random() * phrases.length)] + 
                    "\n\n**Is InnovationKhan's stealth mode active?**" + 
                    `[[☃ radio 1]]`;
